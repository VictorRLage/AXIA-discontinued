import time
# Biblioteca para discretização (definir o intervalo entre capturas)
import subprocess
...
# Biblioteca de conexão com o banco de dados local
...
while True:
    ...
    # CAPTURA MODELO DISCO RÍGIDO PC CMD
